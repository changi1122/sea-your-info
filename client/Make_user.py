...
class Apps(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames={}
        for F in (StartPage, Make_User_page, Find_User_Info, main,Change_User_Info,Mk_U_Suss, ch_U_Suss, Find_ID, Find_PW):
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label=tk.Label(self, text="Sea your Info", font=controller.title_font)
        ...
        label3 = tk.Label(self, text="Login", font=controller.title_font)
        label3.place(x=170, y=80)

        str1 = StringVar()
        LabelWidget1 = tk.Label(self, text="E-mail")
        ...
        str2 = StringVar()
        LabelWidget3 = tk.Label(self, text="PW")
        ...
        button1 = tk.Button(self, text="회원가입", command=lambda: controller.show_frame("Make_User_page"))
        button2 = tk.Button(self, text="아이디/비번 찾기", command=lambda: controller.show_frame("Find_User_Info"))
        button3 = tk.Button(self, text="Login", command=clickMe)
...
class main(tk.Frame):
    def __init__(self,parent, controller):
        ...
        label = tk.Label(self, text="Sea your Info", font=controller.title_font)
        label.pack(side="top", fill="x", pady=10)
        LabelWidget1 = tk.Label(self, text="Main Page")
...
class Make_User_page(tk.Frame):
    ...
    def __init__(self,parent, controller):
        ...
        label2 = tk.Label(self, text="회원가입", font=controller.title_font)
        ...
        str2 = StringVar()
        LabelWidget2 = tk.Label(self, text="Name")
        ...
        str4 = StringVar()
        LabelWidget3_1 = tk.Label(self, text="PW Check")
...
class Change_User_Info(tk.Frame):
    ...
    def __init__(self,parent, controller):
        ...
        label2 = tk.Label(self, text="회원정보 수정", font=controller.title_font)
        label2.place(x=140, y=90)
...
class Find_User_Info(tk.Frame):
    def __init__(self,parent, controller):
        ...
        label2 = tk.Label(self, text="find ID", font=controller.title_font)
        ...
        label3 = tk.Label(self, text="find PW", font=controller.title_font)
        label3.pack(side="top", pady=5)
        label3.place(x=120, y=220)

        LabelWidget3=tk.Label(self, text ="E-mail")
        #LabelWidget3.pack(side=LEFT)
...
class Find_ID(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label2 = tk.Label(self, text="등록하신 아이디는... 입니다.", font=controller.title_font)
...
class Mk_U_Suss(tk.Frame):
    def __init__(self,parent, controller):
        ...
        label2 = tk.Label(self, text="회원가입에 성공했습니다.", font=controller.title_font)
        label2.place(x=200, y=100)
...
class ch_U_Suss(tk.Frame):
    def __init__(self,parent, controller):
        ...
        label2 = tk.Label(self, text="회원정보 변경에 성공했습니다.", font=controller.title_font)
        label2.place(x=200, y=100)
